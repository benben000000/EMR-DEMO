    ...
    <script>
        ...
        function renderAllDynamicTables(state) {
            ...
            renderTableHelper('tbody-verification', state.verification_alerts || [], (v) => `
                <td><strong>${v.item_title}</strong></td>
                <td>${v.department}</td>
                <td>${v.requested_by}</td>
                <td>${v.justification}</td>
                <td><span class="status-badge ${v.status === 'Approved' ? 'status-active' : 'status-urgent'}">${v.status}</span></td>
                <td>
            ...
            renderTableHelper('tbody-mrd', state.mrd_records || [], (m) => `
                <td><strong>${m.hospital_no}</strong></td>
            ...
            renderTableHelper('tbody-helpdesk', state.helpdesk_queries || [], (h) => `
                ...
                <td><strong>${h.visitor_name}</strong></td>
                <td>${h.category}</td>
                <td>${h.action_taken}</td>
                <td>${h.attending_staff}</td>
                <td><span class="status-badge ${h.status === 'Resolved' ? 'status-completed' : 'status-urgent'}">${h.status}</span></td>
                <td>
            ...
            renderTableHelper('tbody-users', state.system_users || [], (u) => `
                ...
                <td>${u.full_name}</td>
                <td><span class="status-badge status-completed">${u.role}</span></td>
                <td>${u.allowed_modules}</td>
                <td><span class="status-badge status-active">${u.session_status}</span></td>
                <td>
