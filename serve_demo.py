...
<body>
            ...
            <section id="view-inventory" class="module-view">
                ...
                <div class="table-card">
                    ...
                    <table class="emr-table" id="table-inventory">
                        ...
                        <tbody>
                            <tr><td><strong>INV-MED-001</strong></td><td>Amoxicillin 500mg Trihydrate Cap</td><td>Antibiotics</td><td>Shelf A-04</td><td>2,450 Caps</td><td>500 Caps</td><td>₱ 6.50</td><td><span class="status-badge status-active">Optimal</span></td><td><button class="btn-secondary" style="padding:4px 8px; font-size:11px;" onclick="showToast('Stock transfer modal opened')">Transfer</button></td></tr>
                            <tr><td><strong>INV-SURG-014</strong></td><td>Surgical Latex Gloves Size 7.5</td><td>Consumables</td><td>Shelf B-12</td><td>18 Boxes</td><td>25 Boxes</td><td>₱ 320.00</td><td><span class="status-badge status-urgent">Low Stock</span></td><td><button class="btn-primary-action" style="padding:4px 8px; font-size:11px;" onclick="showToast('Requisition dispatched to Procurement')">Reorder PO</button></td></tr>
                            <tr><td><strong>INV-IV-002</strong></td><td>0.9% Normal Saline 500mL IV</td><td>IV Fluids</td><td>Pallet C-01</td><td>840 Bags</td><td>200 Bags</td><td>₱ 45.00</td><td><span class="status-badge status-active">Optimal</span></td><td><button class="btn-secondary" style="padding:4px 8px; font-size:11px;" onclick="showToast('Stock transfer modal opened')">Transfer</button></td></tr>
                        </tbody>
                    </table>
                </div>
            </section>
            ...
            <section id="view-procurement" class="module-view">
                ...
                <div class="table-card">
                    <table class="emr-table">
                        ...
                        <tbody>
                            <tr><td><strong>PO-2026-088</strong></td><td>Metro Pharma Supplies Inc.</td><td>Amoxicillin 500mg, IV Cannula 20G</td><td>₱ 85,000.00</td><td><span class="status-badge status-active">Goods Received (GRN Verified)</span></td><td><button class="btn-secondary" style="padding:4px 8px; font-size:11px;" onclick="showToast('Viewing Goods Receipt Note (GRN)...')">View GRN</button></td></tr>
                            <tr><td><strong>PO-2026-089</strong></td><td>Allied Biomedical Instruments</td><td>ECG Thermal Paper, SpO2 Probes</td><td>₱ 42,500.00</td><td><span class="status-badge status-pending">In Transit / Delivery Expected</span></td><td><button class="btn-primary-action" style="padding:4px 8px; font-size:11px;" onclick="showToast('Shipment Tracked: ETA 24-Aug 16:00')">Track Delivery</button></td></tr>
                        </tbody>
                    </table>
                </div>
            </section>
            ...
            <section id="view-substore" class="module-view">
                ...
                <div class="table-card">
                    <table class="emr-table">
                        ...
                        <tbody>
                            <tr><td><strong>ICU SubStore (3rd Floor)</strong></td><td>0.9% Normal Saline 500mL IV</td><td>48 Bags</td><td>20 Bags</td><td><span class="status-badge status-active">Optimal Floor Stock</span></td><td><button class="btn-secondary" style="padding:4px 8px; font-size:11px;" onclick="showToast('Stock Issued to ICU Patient Bed 101')">Issue to Bed</button></td></tr>
                            <tr><td><strong>ER SubStore (Crash Cart)</strong></td><td>Epinephrine 1mg/mL Ampules</td><td>12 Ampules</td><td>10 Ampules</td><td><span class="status-badge status-active">Optimal Floor Stock</span></td><td><button class="btn-secondary" style="padding:4px 8px; font-size:11px;" onclick="showToast('Crash cart checklist signed by Charge Nurse')">Audit Check</button></td></tr>
                            <tr><td><strong>OR SubStore (Suite 1)</strong></td><td>Surgical Gloves Size 7.5 Sterile</td><td>6 Boxes</td><td>10 Boxes</td><td><span class="status-badge status-urgent">Reorder Required</span></td><td><button class="btn-primary-action" style="padding:4px 8px; font-size:11px;" onclick="showToast('STAT Indent dispatched to Central Store')">Reorder STAT</button></td></tr>
                        </tbody>
                    </table>
                </div>
            </section>
            ...
            <section id="view-fixedassets" class="module-view">
                ...
                <div class="table-card">
                    <table class="emr-table">
                        ...
                        <tbody>
                            <tr><td><strong>EQ-RAD-001</strong></td><td>GE Revolution 128-Slice CT Scanner</td><td>Radiology</td><td>₱ 18,500,000</td><td>15-Nov-2026</td><td><span class="status-badge status-active">Under GE OEM AMC</span></td><td><button class="btn-secondary" style="padding:4px 8px; font-size:11px;" onclick="showToast('Calibration cert #CAL-8921 verified')">View Cert</button></td></tr>
                            <tr><td><strong>EQ-ICU-004</strong></td><td>Hamilton-C6 Mechanical Ventilator</td><td>ICU</td><td>₱ 1,850,000</td><td>10-Dec-2026</td><td><span class="status-badge status-active">Calibrated & Certified</span></td><td><button class="btn-secondary" style="padding:4px 8px; font-size:11px;" onclick="showToast('Service log sheet printed')">Service Log</button></td></tr>
                            <tr><td><strong>EQ-OT-002</strong></td><td>Drager Perseus A500 Anesthesia Workstation</td><td>Operating Room</td><td>₱ 3,200,000</td><td>20-Jan-2027</td><td><span class="status-badge status-active">Preventive Maint Pass</span></td><td><button class="btn-secondary" style="padding:4px 8px; font-size:11px;" onclick="showToast('Service log sheet printed')">Service Log</button></td></tr>
                        </tbody>
                    </table>
                </div>
            </section>
            ...
            <section id="view-accounting" class="module-view">
                ...
                <div class="table-card">
                    ...
                    <table class="emr-table">
                        ...
                        <tbody>
                            <tr><td><strong>JV-2026-041</strong></td><td>OPD Consultation Fee Receipt (Cash)</td><td>1010 - Cash on Hand</td><td>4010 - OPD Consultation Revenue</td><td>₱ 2,850.00</td><td><span class="status-badge status-active">Posted</span></td><td><button class="btn-secondary" style="padding:4px 8px; font-size:11px;" onclick="showToast('Voucher JV-2026-041 audited')">View Voucher</button></td></tr>
                            <tr><td><strong>JV-2026-042</strong></td><td>Pharmacy Drug Sales Daily Batch</td><td>1020 - Cash at Bank</td><td>4020 - Pharmacy Sales Revenue</td><td>₱ 18,450.00</td><td><span class="status-badge status-active">Posted</span></td><td><button class="btn-secondary" style="padding:4px 8px; font-size:11px;" onclick="showToast('Voucher JV-2026-042 audited')">View Voucher</button></td></tr>
                            <tr><td><strong>JV-2026-043</strong></td><td>Purchase of Sterile Medical Consumables</td><td>5020 - Medical Supplies Exp</td><td>2010 - Accounts Payable (Metro Pharma)</td><td>₱ 85,000.00</td><td><span class="status-badge status-active">Posted</span></td><td><button class="btn-secondary" style="padding:4px 8px; font-size:11px;" onclick="showToast('Voucher JV-2026-043 audited')">View Voucher</button></td></tr>
                        </tbody>
                    </table>
                </div>
            </section>
            ...
            <section id="view-claimmgmt" class="module-view">
                ...
                <div class="table-card">
                    <table class="emr-table">
                        ...
                        <tbody>
                            <tr><td><strong>CLM-2026-101</strong></td><td>Maria Santos</td><td>Maxicare Gold</td><td>Cardiology Inpatient Case Rate</td><td>₱ 32,400.00</td><td><span class="status-badge status-active">Approved & Reimbursed</span></td><td><button class="btn-secondary" style="padding:4px 8px; font-size:11px;" onclick="showToast('Remittance voucher downloaded')">Voucher</button></td></tr>
                            <tr><td><strong>CLM-2026-102</strong></td><td>Juan Dela Cruz</td><td>PhilHealth Primary</td><td>First Case Rate (Pneumonia)</td><td>₱ 15,000.00</td><td><span class="status-badge status-pending">Under Pre-Auth Review</span></td><td><button class="btn-primary-action" style="padding:4px 8px; font-size:11px;" onclick="showToast('Pre-Auth inquiry dispatched to PhilHealth')">Follow Up</button></td></tr>
                            <tr><td><strong>CLM-2026-103</strong></td><td>Antonio Gonzales</td><td>Intellicare Corporate</td><td>Occupational Physical Therapy</td><td>₱ 8,500.00</td><td><span class="status-badge status-completed">Voucher Paid</span></td><td><button class="btn-secondary" style="padding:4px 8px; font-size:11px;" onclick="showToast('Remittance voucher downloaded')">Voucher</button></td></tr>
                        </tbody>
                    </table>
                </div>
            </section>
            ...
            <section id="view-incentive" class="module-view">
                ...
                <div class="table-card">
                    <table class="emr-table">
                        ...
                        <tbody>
                            <tr><td><strong>Dr. Roberto Tan, MD</strong></td><td>Cardiology</td><td>48 OPD + 8 Cath</td><td>₱ 240,000.00</td><td>₱ 72,000.00</td><td><strong style="color:#15803d;">₱ 168,000.00</strong></td><td><span class="status-badge status-completed">Processed</span></td><td><button class="btn-secondary" style="padding:4px 8px; font-size:11px;" onclick="showToast('Payout slip printed')">Payout Slip</button></td></tr>
                            <tr><td><strong>Dr. Edward Hernandez, MD</strong></td><td>General Surgery</td><td>14 Surgeries</td><td>₱ 180,000.00</td><td>₱ 54,000.00</td><td><strong style="color:#15803d;">₱ 126,000.00</strong></td><td><span class="status-badge status-active">Approved</span></td><td><button class="btn-primary-action" style="padding:4px 8px; font-size:11px;" onclick="showToast('Direct bank transfer initiated')">Release Pay</button></td></tr>
                        </tbody>
                    </table>
                </div>
            </section>
            ...
            <section id="view-vaccination" class="module-view">
                ...
                <div class="table-card">
                    <table class="emr-table">
                        ...
                        <tbody>
                            <tr><td><strong>Lucas Gabriel Santos</strong></td><td>6 Months / M</td><td>Pentavalent (DTP-HepB-Hib)</td><td>Dose 3 &bull; IM Anterolateral Thigh</td><td>LOT-PV-9012 (Exp: 2027)</td><td><span class="status-badge status-completed">Completed</span></td><td>Nurse Clara Dizon</td></tr>
                            <tr><td><strong>Elena Reyes</strong></td><td>28 Y / F</td><td>Influenza Quadrivalent 2026</td><td>0.5 mL &bull; IM Deltoid</td><td>LOT-FLU-3312 (Exp: 2027)</td><td>Aug-2027 (Annual)</td><td>Nurse Clara Dizon</td></tr>
                        </tbody>
                    </table>
                </div>
            </section>
            ...
            <section id="view-queue" class="module-view">
                ...
                <div class="table-card">
                    ...
                    <table class="emr-table">
                        ...
                        <tbody>
                            <tr><td><strong style="font-size:16px; color:var(--brand-primary);">A-103</strong></td><td>Juan Dela Cruz</td><td>Dr. Roberto Tan, MD</td><td>Room 201 (Cardiology)</td><td><span class="status-badge status-active">Currently Inside Room</span></td><td><button class="btn-secondary" style="padding:4px 8px; font-size:11px;" onclick="showToast('Recall chime played in waiting area')">Recall</button></td></tr>
                            <tr><td><strong style="font-size:16px;">A-104</strong></td><td>Elena Reyes</td><td>Dr. Vincent Lim, MD</td><td>Room 203 (Neurology)</td><td><span class="status-badge status-urgent">Next in Line</span></td><td><button class="btn-primary-action" style="padding:4px 8px; font-size:11px;" onclick="showToast('Calling Token A-104')">Call Now</button></td></tr>
                            <tr><td><strong style="font-size:16px;">A-105</strong></td><td>Antonio Gonzales</td><td>Dr. Miguel Garcia, MD</td><td>Room 204 (Orthopedics)</td><td><span class="status-badge status-pending">Waiting</span></td><td><button class="btn-secondary" style="padding:4px 8px; font-size:11px;" onclick="showToast('Patient notified via SMS')">Notify</button></td></tr>
                        </tbody>
                    </table>
                </div>
            </section>
            ...
            <section id="view-cssd" class="module-view">
                ...
                <div class="table-card">
                    <table class="emr-table">
                        ...
                        <tbody>
                            <tr><td><strong>CSSD-SET-101</strong></td><td>Laparoscopic Cholecystectomy Set</td><td>Autoclave 1 (Steam)</td><td>24-Aug-2026 09:00 AM</td><td><span class="status-badge status-active">Passed (Negative)</span></td><td>24-Nov-2026</td></tr>
                            <tr><td><strong>CSSD-SET-102</strong></td><td>Major Orthopedic Knee Set</td><td>Autoclave 2 (Steam)</td><td>24-Aug-2026 10:30 AM</td><td><span class="status-badge status-active">Passed (Negative)</span></td><td>24-Nov-2026</td></tr>
                        </tbody>
                    </table>
                </div>
            </section>
            ...
            <section id="view-mktreferral" class="module-view">
                ...
                <div class="table-card">
                    <table class="emr-table">
                        ...
                        <tbody>
                            <tr><td><strong>Makati Family Clinic</strong></td><td>Dr. Manuel Fernandez, MD</td><td>18 Patients</td><td>Cardiology & Echo</td><td><span class="status-badge status-active">Active (Standard Tier)</span></td></tr>
                            <tr><td><strong>BGC Health Hub</strong></td><td>Dr. Patricia Santos, MD</td><td>12 Patients</td><td>Neurology & Brain MRI</td><td><span class="status-badge status-active">Active (Preferred Tier)</span></td></tr>
                        </tbody>
                    </table>
                </div>
            </section>
    ...
    <script>
        ...
        // ==========================================================================
        // COMPREHENSIVE REACTIVE LIVE DATA PERSISTENCE & GLOBAL SYNC ENGINE
        // ==========================================================================
        ...
        // Load and sync live state across all 35 modules
        async function loadLiveEMRState() {
            try {
                ...
                console.warn('Live EMR state sync:', e);
            }
        }

        // Render Patient Master Table in all patient views
        function renderLivePatientsTable(patients) {
                ...
                patients.forEach(p => {
                    ...
                    tr.innerHTML = `
                        ...
                        <td>
                            ...
                            <button class="btn-secondary" style="padding: 4px 8px; font-size: 11px;" onclick="viewPatient360('${p.name}', '${p.patient_no}')">
            ...
            // Update Total Patient Count KPIs
            const kpiTotal = document.getElementById('dash-total-patients') || document.querySelector('#view-patient-reg .stat-content h3');
            if (kpiTotal) kpiTotal.textContent = patients.length;
        }

        // Populate all patient select dropdowns across the application
        function populatePatientDropdowns(patients) {
            const dropdownIds = ['apt-patient', 'edit-bed-patient', 'inv-pat-select'];
            ...
            // Populate Quick Patient Switcher Modal list
            const modalList = document.getElementById('patient-modal-list');
            if (modalList) {
                modalList.innerHTML = '';
                patients.forEach(p => {
                    ...
                    item.innerHTML = `
                        <div class="pat-avatar">${p.name.split(' ').map(n=>n[0]).join('').substring(0,2)}</div>
                        <div class="pat-info">
                            <h4>${p.name}</h4>
                            <p>${p.patient_no} &bull; ${p.age} Y / ${p.gender} &bull; ${p.insurance_no || 'PhilHealth'}</p>
                        </div>
                        <button class="btn-select-pat"><i class="fa-solid fa-check"></i> Select</button>
                    `;
        ...
        function renderLiveAppointmentsTable(appointments) {
            ...
            appointments.forEach(a => {
                const tr = document.createElement('tr');
                tr.innerHTML = `
                    <td><strong>APT-2026-${String(a.id).padStart(4, '0')}</strong></td>
                    ...
                    <td><button class="btn-primary-action" style="padding:4px 8px; font-size:11px;" onclick="showToast('Patient checked in for consultation')">Check-In</button></td>
                `;
                tbody.appendChild(tr);
            });

            const kpiAppts = document.querySelector('#view-appointments .stat-content h3');
            if (kpiAppts) kpiAppts.textContent = appointments.length;
        }
        ...
        // ==========================================
        // 1. LIVE PERSISTENT PATIENT REGISTRATION
        // ==========================================
        ...
        // ==========================================
        // 2. LIVE PERSISTENT APPOINTMENT BOOKING
        // ==========================================
        async function saveNewAppointment() {
            const patSelect = document.getElementById('apt-patient');
            const patName = patSelect ? patSelect.value : (document.getElementById('global-pat-name') ? document.getElementById('global-pat-name').textContent : 'Patient');
        ...
        // ==========================================
        // 3. LIVE PERSISTENT BED MANAGEMENT
        // ==========================================
            ...
            try {
                await fetch('/api/beds/status', {
                    ...
                    body: JSON.stringify({
                        ...
                        doctor: status === 'available' ? null : doctor
                    })
                });

                closeModal('modal-manage-bed');
                showToast(`✅ Bed ${bedId} updated to ${status.toUpperCase()} and saved to database!`);
                await loadLiveEMRState();
            } catch (err) {
                closeModal('modal-manage-bed');
            }
        ...
        // ==========================================
        // 4. LIVE PERSISTENT ER TRIAGE CASE
        // ==========================================
        async function saveERCaseDetails() {
            const caseCode = document.getElementById('edit-er-code') ? document.getElementById('edit-er-code').value : 'ER-2026-09';
            ...
            const complaint = document.getElementById('edit-er-complaint') ? document.getElementById('edit-er-complaint').value : 'Acute Emergency Symptoms';
            ...
            const vitals = `BP: ${bp} | HR: ${hr} | SpO2: ${spo2}`;
            const doctor = document.getElementById('edit-er-doctor') ? document.getElementById('edit-er-doctor').value : 'Dr. Roberto Tan, MD';
            const disp = document.getElementById('edit-er-disposition') ? document.getElementById('edit-er-disposition').value : 'Admit to Inpatient';
