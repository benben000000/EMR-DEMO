...
<body>
    ...
    <div class="main-wrapper">
        ...
        <header class="top-navbar">
            ...
            <div class="global-search-wrapper">
                ...
                <input type="text" class="global-search-input" placeholder="Quick Search Patient, Chart, CPT..." onkeyup="handleGlobalPatientSearch(this)" />
            </div>

            <!-- User Profile & Secure Sign Out -->
            <div class="user-profile" onclick="openModal('modal-switch-role')" style="cursor:pointer;" title="Click to switch workspace role">
        ...
        <main class="content-area">
            ...
            <section id="view-dashboard" class="module-view active">
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card cyan">
                        ...
                        <div class="stat-content">
                            <h3 id="dash-stat-appointments">--</h3>
                ...
                <div class="grid-2col">
                    <div class="card-box">
                        ...
                        <table class="emr-table">
                            ...
                            <tbody id="tbody-dashboard-patients"></tbody>
                        </table>
                    </div>
                    ...
                    <div class="card-box">
                        ...
                        <table class="emr-table">
                            ...
                            <tbody id="tbody-dashboard-aicrm"></tbody>
                        </table>
                    </div>
                </div>
            </section>
            ...
            <section id="view-patient-reg" class="module-view">
                ...
                <div class="table-card">
                    ...
                    <table class="emr-table" id="patient-master-table">
                        ...
                        <tbody id="tbody-patient-reg"></tbody>
                    </table>
                </div>
            </section>
                ...
                <div class="clinical-layout">
                    <div class="patient-queue-card">
                        <div style="font-size:13px; font-weight:800; color:#0f172a; margin-bottom:12px; display:flex; align-items:center; justify-content:space-between;">
                            ...
                            <span class="badge-new" id="opd-queue-count" style="background:#e2e8f0; color:#475569;">-- Total</span>
                        </div>
                        <div id="clinical-opd-queue-list"></div>
                    </div>
                        ...
                        <div class="card-box">
                            <div class="card-box-header">
                                <h3>
                                    ...
                                    Active Chart: <span id="emr-patient-title">John Doe (68 Y / Male)</span>
                                </h3>
                                <div style="display:flex; gap:8px;">
                                    <span class="status-badge status-active" id="emr-hospital-badge">Hospital No: G1-US-0090</span>
            ...
            <section id="view-aicrm" class="module-view">
                ...
                <div class="table-card">
                    ...
                    <table class="emr-table" id="crm-leads-table">
                        ...
                        <tbody id="tbody-crm-leads"></tbody>
                    </table>
                </div>
            </section>
                ...
                <div class="card-box" style="margin-bottom:24px;">
                    <div style="display:flex; align-items:center; justify-content:space-between;">
                        <div style="display:flex; align-items:center; gap:16px;">
                            ...
                            <div>
                                <h2 style="font-size:20px; font-weight:800; color:#0f172a;" id="p360-name">Mary Smith</h2>
                                <p style="font-size:13px; color:#64748b;">Hospital No: <strong id="p360-code">G1-US-0091</strong> &bull; <span id="p360-submeta">34 Y / Female &bull; Blood Group: B+ &bull; HMO: Gold Care</span></p>
                            </div>
                        </div>
                        <div style="display:flex; gap:10px;">
                            <button class="btn-secondary" onclick="openModal('modal-select-patient')">
                ...
                <div class="grid-2col">
                    <div class="card-box">
                        ...
                        <table class="emr-table" id="table-macros">
                            ...
                            <tbody id="tbody-templates"></tbody>
                        </table>
                    </div>
                    <div class="card-box">
                        ...
                        <table class="emr-table">
                            ...
                            <tbody id="tbody-ordersets"></tbody>
                        </table>
                    </div>
                </div>
            </section>
            ...
            <section id="view-inventory" class="module-view">
                ...
                <div class="stats-grid">
                    <div class="stat-card"><div class="stat-icon"><i class="fa-solid fa-boxes-stacked"></i></div><div class="stat-content"><h3 id="inv-total-skus">--</h3><p>Total Active SKUs</p></div></div>
                    <div class="stat-card cyan"><div class="stat-icon"><i class="fa-solid fa-triangle-exclamation"></i></div><div class="stat-content"><h3 id="inv-low-stock">--</h3><p>Below Safety Reorder Level</p></div></div>
                    <div class="stat-card teal"><div class="stat-icon"><i class="fa-solid fa-warehouse"></i></div><div class="stat-content"><h3 id="inv-total-value">--</h3><p>Total Inventory Asset Value</p></div></div>
                </div>
                <div class="table-card">
                    <div class="table-toolbar">
            ...
            <section id="view-procurement" class="module-view">
                ...
                <div class="stats-grid">
                    <div class="stat-card"><div class="stat-icon"><i class="fa-solid fa-file-signature"></i></div><div class="stat-content"><h3 id="po-open-value">--</h3><p>Active Open PO Value</p></div></div>
                    <div class="stat-card cyan"><div class="stat-icon"><i class="fa-solid fa-truck-ramp-box"></i></div><div class="stat-content"><h3 id="po-pending-count">--</h3><p>Pending Deliveries</p></div></div>
                    <div class="stat-card teal"><div class="stat-icon"><i class="fa-solid fa-handshake"></i></div><div class="stat-content"><h3 id="po-vendor-count">--</h3><p>Approved Medical Vendors</p></div></div>
                </div>
                <div class="table-card">
                    <table class="emr-table">
            ...
            <section id="view-accounting" class="module-view">
                ...
                <div class="stats-grid">
                    <div class="stat-card"><div class="stat-icon"><i class="fa-solid fa-building-columns"></i></div><div class="stat-content"><h3 id="acc-cash-bank">--</h3><p>Cash at Bank (Operating)</p></div></div>
                    <div class="stat-card cyan"><div class="stat-icon"><i class="fa-solid fa-file-invoice-dollar"></i></div><div class="stat-content"><h3 id="acc-ar-hmo">--</h3><p>Accounts Receivable (HMOs)</p></div></div>
                    <div class="stat-card teal"><div class="stat-icon"><i class="fa-solid fa-book"></i></div><div class="stat-content"><h3 id="acc-dr-incentive">--</h3><p>Doctor Incentive Payable</p></div></div>
                </div>
                <div class="table-card">
            ...
            <section id="view-incentive" class="module-view">
                ...
                <div class="table-card">
                    <table class="emr-table">
                        ...
                        <tbody id="tbody-incentives"></tbody>
                    </table>
                </div>
            </section>
            ...
            <section id="view-verification" class="module-view">
                <div class="ux-navigation-bar">
                    <div class="breadcrumbs">
                        <a onclick="switchTab('view-dashboard', null)"><i class="fa-solid fa-house"></i> Home</a>
                        <i class="fa-solid fa-chevron-right" style="font-size:10px;"></i>
                        <span class="current">Clinical Verification</span>
                    </div>
                    <button class="btn-back-dashboard" onclick="switchTab('view-dashboard', null)"><i class="fa-solid fa-arrow-left"></i> Back to Dashboard</button>
                </div>
                <div class="view-header">
                    <div>
                        <h1>Clinical Order Verification & High-Risk Sign-Off</h1>
                        <p>Dual-witness sign-offs for narcotics, chemotherapy protocols, blood transfusions, and critical lab alerts</p>
                    </div>
                </div>
                <div class="table-card">
                    <table class="emr-table">
                        <thead><tr><th>Order / Test Title</th><th>Department</th><th>Requested By</th><th>Verification Reason</th><th>Status</th><th>Actions</th></tr></thead>
                        <tbody id="tbody-verification"></tbody>
                    </table>
                </div>
            </section>
    
        
            <!-- 22. IMMUNIZATION & VACCINE REGISTRY -->
            <section id="view-vaccination" class="module-view">
                <div class="ux-navigation-bar">
                    <div class="breadcrumbs">
                        <a onclick="switchTab('view-dashboard', null)"><i class="fa-solid fa-house"></i> Home</a>
                        <i class="fa-solid fa-chevron-right" style="font-size:10px;"></i>
                        <span class="current">Vaccine Registry</span>
                    </div>
                    <button class="btn-back-dashboard" onclick="switchTab('view-dashboard', null)"><i class="fa-solid fa-arrow-left"></i> Back to Dashboard</button>
                </div>
                <div class="view-header">
                    ...
                    <button class="btn-primary-action" onclick="openModal('modal-record-vaccine')"><i class="fa-solid fa-syringe"></i> + Record Vaccine Dose</button>
                </div>
                <div class="stats-grid">
                    <div class="stat-card"><div class="stat-icon"><i class="fa-solid fa-temperature-arrow-down"></i></div><div class="stat-content"><h3 id="vax-fridge-temp">+3.8 °C</h3><p>Vaccine Refrigerator (Safe +2 to +8°C)</p></div></div>
                    <div class="stat-card cyan"><div class="stat-icon"><i class="fa-solid fa-child-reaching"></i></div><div class="stat-content"><h3 id="vax-coverage">98.2%</h3><p>Pediatric EPI On-Time Coverage</p></div></div>
                    <div class="stat-card teal"><div class="stat-icon"><i class="fa-solid fa-shield-virus"></i></div><div class="stat-content"><h3 id="vax-monthly-doses">--</h3><p>Doses Administered This Month</p></div></div>
                </div>
                <div class="table-card">
                    <table class="emr-table">
            ...
            <section id="view-queue" class="module-view">
                ...
                <div class="view-header">
                    ...
                    <div style="display:flex; gap:10px;">
                        <button class="btn-accent-action" onclick="callNextQueueToken()"><i class="fa-solid fa-volume-high"></i> Call Next Waiting Token</button>
                        <button class="btn-primary-action" onclick="openModal('modal-new-token')"><i class="fa-solid fa-ticket"></i> + Issue Token</button>
                    </div>
                </div>
                <div class="grid-3col">
                    <div class="stat-card cyan"><div class="stat-icon"><i class="fa-solid fa-bullhorn"></i></div><div class="stat-content"><h3 id="queue-now-serving" style="color:#0284c7;">--</h3><p id="queue-now-room-text">Now Serving in Room 201</p></div></div>
                    <div class="stat-card teal"><div class="stat-icon"><i class="fa-solid fa-users"></i></div><div class="stat-content"><h3 id="queue-waiting-count">--</h3><p>Waiting in OPD Waiting Hall</p></div></div>
                    <div class="stat-card"><div class="stat-icon"><i class="fa-solid fa-clock"></i></div><div class="stat-content"><h3 id="queue-avg-time">--</h3><p>Average Wait Time</p></div></div>
                </div>
                <div class="table-card">
                    <div class="table-toolbar"><h3 style="font-size:15px; font-weight:700;">Live Waiting Room Token Display</h3></div>
                    <table class="emr-table">
                        <thead><tr><th>Token No</th><th>Patient Name</th><th>Department</th><th>Counter / Room</th><th>Priority Level</th><th>Queue Status</th><th>Action</th></tr></thead>
            ...
            <section id="view-cssd" class="module-view">
                ...
                <div class="view-header">
                    ...
                    <button class="btn-primary-action" onclick="openModal('modal-start-cssd')"><i class="fa-solid fa-play"></i> + Start Autoclave Cycle</button>
                </div>
                <div class="grid-3col">
                    <div class="stat-card"><div class="stat-icon"><i class="fa-solid fa-temperature-high"></i></div><div class="stat-content"><h3 id="cssd-temp">134.2 °C</h3><p>Autoclave Sterilizer 1 (Pass)</p></div></div>
                    <div class="stat-card cyan"><div class="stat-icon"><i class="fa-solid fa-box-archive"></i></div><div class="stat-content"><h3 id="cssd-trays-ready">--</h3><p>Sterile Surgical Trays Ready</p></div></div>
                    <div class="stat-card teal"><div class="stat-icon"><i class="fa-solid fa-circle-check"></i></div><div class="stat-content"><h3 id="cssd-pass-rate">100%</h3><p>Biological Indicator Pass Rate</p></div></div>
                </div>
                <div class="table-card">
                    <table class="emr-table">
            ...
            <section id="view-medicalrecords" class="module-view">
                ...
                <div class="view-header">
                    ...
                    <button class="btn-primary-action" onclick="openModal('modal-archive-mrd')"><i class="fa-solid fa-folder-plus"></i> + Archive Patient File</button>
                </div>
                <div class="table-card">
                    <table class="emr-table">
            ...
            <section id="view-systemadmin" class="module-view">
                ...
                <div class="view-header">
                    ...
                    <button class="btn-primary-action" onclick="openModal('modal-create-user')"><i class="fa-solid fa-user-shield"></i> + Create Staff User</button>
                </div>
                <div class="table-card">
        ...
        <div class="modal-box">
            ...
            <div class="modal-body">
                ...
                <div style="display:flex; flex-direction:column; gap:8px; max-height:280px; overflow-y:auto;" id="pat-modal-list">
                    <div class="queue-item" onclick="setActivePatient('John Doe'); closeModal('modal-select-patient');">
                        <div class="q-name"><span>John Doe</span><span class="status-badge status-active">Medicare Part B</span></div>
                        <div class="q-sub">Hospital No: G1-US-0090 &bull; 68 Y / Male &bull; Tension Headache</div>
                    </div>
                    <div class="queue-item" onclick="setActivePatient('Mary Smith'); closeModal('modal-select-patient');">
                        <div class="q-name"><span>Mary Smith</span><span class="status-badge status-completed">Blue Cross Blue Shield</span></div>
                        <div class="q-sub">Hospital No: G1-US-0091 &bull; 34 Y / Female &bull; Cardiology Follow-up</div>
                    </div>
                    <div class="queue-item" onclick="setActivePatient('Emily Davis'); closeModal('modal-select-patient');">
                        <div class="q-name"><span>Emily Davis</span><span class="status-badge status-pending">Self-Pay</span></div>
                        <div class="q-sub">Hospital No: G1-US-0093 &bull; 28 Y / Female &bull; Neurological Checkup</div>
                    </div>
                    <div class="queue-item" onclick="setActivePatient('Antonio Gonzales'); closeModal('modal-select-patient');">
                        ...
                        <div class="q-sub">Hospital No: G1-US-0092 &bull; 52 Y / Male &bull; Annual Checkup</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <select id="edit-bed-patient" class="form-control" onchange="handleBedPatientChange(this)">
                                ...
                                <option value="John Doe">John Doe (G1-US-0090)</option>
                                <option value="Mary Smith">Mary Smith (G1-US-0091)</option>
                                <option value="Emily Davis">Emily Davis (G1-US-0093)</option>
                                <option value="Antonio Gonzales">Antonio Gonzales (G1-US-0092)</option>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <select class="form-control">
                            <option>Emily Davis (G1-US-0093)</option>
                            <option>Mary Smith (G1-US-0091)</option>
                            <option>John Doe (G1-US-0090)</option>
                        </select>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body">
                <div class="printable-invoice" id="print-area">
                    ...
                    <div style="margin-bottom:16px; font-size:13px;">
                        <p><strong>Patient Name:</strong> <span id="rcpt-patient">Mary Smith</span></p>
    ...
    <div id="modal-report-incident" class="modal-overlay">
        <div class="modal-box">
            ...
            <div class="modal-body">
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" id="inc-staff" class="form-control" placeholder="Employee Name / ID" />
                    </div>
                    <div class="form-group">
                        <label>Incident Department</label>
                        <select id="inc-dept" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <select id="inc-severity" class="form-control">
            ...
            <div class="modal-footer">
                ...
                <button class="btn-primary-action" onclick="submitIncidentReport()">Submit Safety Report</button>
            </div>
        </div>
    </div>
    ...
    <div id="modal-new-template" class="modal-overlay">
        <div class="modal-box" style="max-width:550px;">
            ...
            <div class="modal-footer">
                ...
                <button class="btn-primary-action" onclick="submitNewTemplate()">Save Template</button>
            </div>
        </div>
    </div>
    ...
    <div id="modal-new-po" class="modal-overlay">
        <div class="modal-box" style="max-width:550px;">
            ...
            <div class="modal-footer">
                ...
                <button class="btn-primary-action" onclick="submitNewPO()">Create & Send PO</button>
            </div>
        </div>
    </div>
    ...
    <div id="modal-new-voucher" class="modal-overlay">
        <div class="modal-box" style="max-width:550px;">
            ...
            <div class="modal-body">
                <div class="form-group"><label>Transaction Description / Narration</label><input type="text" id="jv-narration" class="form-control" placeholder="e.g. Cash Settlement for OR Supplies" /></div>
                <div class="grid-2col">
            ...
            <div class="modal-footer">
                ...
                <button class="btn-primary-action" onclick="submitNewVoucher()">Post Voucher</button>
            </div>
        </div>
    </div>
            ...
            <div class="modal-body">
                ...
                <div class="form-grid" style="margin-bottom:14px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="code-blue-patient-name" class="form-control" value="John Doe (G1-US-0090)" />
                    </div>
                </div>
    ...
    <div id="modal-new-token" class="modal-overlay">
        <div class="modal-box" style="max-width:520px;">
            <div class="modal-header">
                <h3><i class="fa-solid fa-ticket"></i> Issue OPD Consultation Token</h3>
                <button class="modal-close" onclick="closeModal('modal-new-token')">&times;</button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label>Patient Name *</label>
                    <select id="tok-patient-select" class="form-control"></select>
                </div>
                <div class="grid-2col">
                    <div class="form-group">
                        <label>Department *</label>
                        <select id="tok-dept" class="form-control">
                    ...
                    <div class="form-group">
                        <label>Counter / Room *</label>
                        <select id="tok-counter" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <select id="tok-priority" class="form-control">
            ...
            <div class="modal-footer">
                <button class="btn-secondary" onclick="closeModal('modal-new-token')">Cancel</button>
                <button class="btn-primary-action" onclick="submitNewToken()"><i class="fa-solid fa-print"></i> Issue & Print Token</button>
            </div>
        </div>
    </div>

    <!-- MODAL: RECORD VACCINE DOSE -->
    <div id="modal-record-vaccine" class="modal-overlay">
        <div class="modal-box" style="max-width:520px;">
            <div class="modal-header">
                <h3><i class="fa-solid fa-syringe"></i> Record Vaccine Dose</h3>
                <button class="modal-close" onclick="closeModal('modal-record-vaccine')">&times;</button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label>Patient Name *</label>
                    <select id="vax-patient-select" class="form-control"></select>
                </div>
                <div class="grid-2col">
                    <div class="form-group">
                        <label>Vaccine Antigen *</label>
                        <select id="vax-antigen" class="form-control">
                            <option value="Hepatitis B (Recombivax)">Hepatitis B (Recombivax)</option>
                            ...
                            <option value="Pneumococcal Conjugate (PCV13)">Pneumococcal Conjugate (PCV13)</option>
                            <option value="Measles-Mumps-Rubella (MMR)">Measles-Mumps-Rubella (MMR)</option>
                            <option value="COVID-19 Bivalent Booster">COVID-19 Bivalent Booster</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Dose Number *</label>
                        <select id="vax-dose" class="form-control">
                ...
                <div class="grid-2col">
                    <div class="form-group">
                        ...
                        <input type="text" id="vax-batch" class="form-control" placeholder="e.g. LOT-2026-X99" />
                    </div>
                    <div class="form-group">
                        <label>Administered By</label>
                        <input type="text" id="vax-admin-by" class="form-control" value="Nurse Joy Reyes, RN" />
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn-secondary" onclick="closeModal('modal-record-vaccine')">Cancel</button>
                <button class="btn-primary-action" onclick="submitRecordVaccine()"><i class="fa-solid fa-floppy-disk"></i> Record Dose in Registry</button>
            </div>
        </div>
    </div>

    <!-- MODAL: START CSSD AUTOCLAVE CYCLE -->
    <div id="modal-start-cssd" class="modal-overlay">
        <div class="modal-box" style="max-width:520px;">
            <div class="modal-header">
                <h3><i class="fa-solid fa-play"></i> Start CSSD Sterilization Cycle</h3>
                <button class="modal-close" onclick="closeModal('modal-start-cssd')">&times;</button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label>Autoclave Unit *</label>
                    <select id="cssd-unit" class="form-control">
                        <option value="Autoclave Sterilizer 1">Autoclave Sterilizer 1 (Main OT)</option>
                        <option value="Autoclave Sterilizer 2">Autoclave Sterilizer 2 (ER Annex)</option>
                        <option value="Flash Autoclave Unit">Flash Autoclave Unit (STAT)</option>
                    </select>
                </div>
                <div class="form-group">
                    <label>Surgical Instrument Tray / Set *</label>
                    <input type="text" id="cssd-tray" class="form-control" placeholder="e.g. Major Laparotomy Instrument Set #4" />
                </div>
                <div class="grid-2col">
                    <div class="form-group">
                        <label>Sterilization Cycle</label>
                        <select id="cssd-cycle-time" class="form-control">
                            <option value="134°C for 18 mins">134°C for 18 mins (Porous/Instruments)</option>
                            <option value="121°C for 30 mins">121°C for 30 mins (Rubber/Plastics)</option>
                            <option value="134°C for 4 mins (STAT Flash)">134°C for 4 mins (STAT Flash)</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Biological Indicator</label>
                        <select id="cssd-bio" class="form-control">
                            <option value="Pass (Sterile)">Pass (Sterile)</option>
                            <option value="Incubating (Pending)">Incubating (Pending)</option>
                        </select>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn-secondary" onclick="closeModal('modal-start-cssd')">Cancel</button>
                <button class="btn-primary-action" onclick="submitStartCSSD()"><i class="fa-solid fa-play"></i> Initiate Cycle</button>
            </div>
        </div>
    </div>

    <!-- MODAL: ARCHIVE MRD RECORD -->
    <div id="modal-archive-mrd" class="modal-overlay">
        <div class="modal-box" style="max-width:520px;">
            <div class="modal-header">
                <h3><i class="fa-solid fa-folder-plus"></i> Archive Patient Medical Record (MRD)</h3>
                <button class="modal-close" onclick="closeModal('modal-archive-mrd')">&times;</button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label>Patient *</label>
                    <select id="mrd-patient-select" class="form-control"></select>
                </div>
                <div class="grid-2col">
                    <div class="form-group">
                        <label>Discharge Date</label>
                        <input type="date" id="mrd-disch-date" class="form-control" />
                    </div>
                    <div class="form-group">
                        <label>Primary ICD-10 Code</label>
                        <input type="text" id="mrd-icd" class="form-control" placeholder="e.g. I10 - Essential Hypertension" />
                    </div>
                </div>
                <div class="form-group">
                    <label>Physical Shelf Location / Digital Index</label>
                    <input type="text" id="mrd-shelf" class="form-control" placeholder="e.g. Section B, Rack 4, Shelf 02" />
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn-secondary" onclick="closeModal('modal-archive-mrd')">Cancel</button>
                <button class="btn-primary-action" onclick="submitArchiveMRD()"><i class="fa-solid fa-box-archive"></i> Archive & Index Chart</button>
            </div>
        </div>
    </div>
    ...
    <div id="modal-create-user" class="modal-overlay">
        <div class="modal-box" style="max-width:520px;">
            <div class="modal-header">
                <h3><i class="fa-solid fa-user-shield"></i> Create Staff User Account</h3>
            ...
            <div class="modal-body">
                <div class="grid-2col">
                    <div class="form-group">
                        ...
                        <input type="text" id="usr-name" class="form-control" placeholder="e.g. dr.santos" />
                    </div>
                    <div class="form-group">
                        <label>Full Staff Name *</label>
                        <input type="text" id="usr-fullname" class="form-control" placeholder="e.g. Dr. Miguel Santos, MD" />
                    </div>
                </div>
                <div class="grid-2col">
                    <div class="form-group">
                        ...
                        <select id="usr-role" class="form-control">
                            ...
                            <option value="Lab Medical Technologist">Lab Medical Technologist</option>
                    ...
                    <div class="form-group">
                        ...
                        <select id="usr-modules" class="form-control">
                            ...
                            <option value="Diagnostics Only">Diagnostics Only</option>
                        </select>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn-secondary" onclick="closeModal('modal-create-user')">Cancel</button>
                <button class="btn-primary-action" onclick="submitCreateUser()"><i class="fa-solid fa-user-check"></i> Register User Account</button>
            </div>
        </div>
    </div>

    <!-- MODAL: ADD WAREHOUSE INVENTORY ITEM -->
    <div id="modal-new-stock-item" class="modal-overlay">
        <div class="modal-box" style="max-width:540px;">
            <div class="modal-header">
                <h3><i class="fa-solid fa-boxes-packing"></i> Add Warehouse Inventory Item</h3>
                <button class="modal-close" onclick="closeModal('modal-new-stock-item')">&times;</button>
            </div>
            <div class="modal-body">
                <div class="grid-2col">
                    <div class="form-group">
                        <label>SKU / Item Code *</label>
                        <input type="text" id="itm-code" class="form-control" placeholder="e.g. MED-7788" />
                    </div>
                    <div class="form-group">
                        <label>Item Name & Strength *</label>
                        <input type="text" id="itm-name" class="form-control" placeholder="e.g. Ceftriaxone 1g Vial" />
                    </div>
                </div>
                <div class="grid-2col">
                    <div class="form-group">
                        <label>Category *</label>
                        <select id="itm-cat" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="itm-batch" class="form-control" placeholder="e.g. BAT-2026-A1" />
                    </div>
                </div>
                <div class="grid-3col">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="itm-reorder" class="form-control" placeholder="25" />
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn-secondary" onclick="closeModal('modal-new-stock-item')">Cancel</button>
    <!-- MODAL: SWITCH DEPARTMENT WORKSPACE ROLE -->
    <div id="modal-switch-role" class="modal-overlay">
        <div class="modal-box" style="max-width:560px;">
            <div class="modal-header">
                <h3><i class="fa-solid fa-id-badge"></i> Switch Department Workspace</h3>
                <button class="modal-close" onclick="closeModal('modal-switch-role')">&times;</button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button class="btn-secondary" onclick="closeModal('modal-switch-role')">Close</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function switchDepartmentRole(roleKey) {
            const matched = VALID_USERS[roleKey] || VALID_USERS['admin'];
            sessionStorage.setItem('g1_user', roleKey);
            sessionStorage.setItem('g1_role_key', matched.role_key || roleKey);
            sessionStorage.setItem('g1_user_name', matched.name);
            sessionStorage.setItem('g1_user_role', matched.role);
            sessionStorage.setItem('g1_user_avatar', matched.avatar);
            sessionStorage.setItem('g1_user_badge', matched.badge);
            localStorage.setItem('g1_user', roleKey);
            localStorage.setItem('g1_role_key', matched.role_key || roleKey);

            applyRolePermissions();
            closeModal('modal-switch-role');
            showToast(`Switched active workspace to ${matched.badge}`);
        }

        // Apply Strict Role Permissions & Rebuild DOM
        function applyRolePermissions() {
            const roleKey = sessionStorage.getItem('g1_role_key') || localStorage.getItem('g1_role_key') || 'admin';
            const matched = VALID_USERS[roleKey] || VALID_USERS['admin'];

            const userBadge = sessionStorage.getItem('g1_user_badge') || matched.badge;
            const uName = sessionStorage.getItem('g1_user_name') || matched.name;
            const uRole = sessionStorage.getItem('g1_user_role') || matched.role;
            const uAvatar = sessionStorage.getItem('g1_user_avatar') || matched.avatar;

            // 1. Update Header Badges & Profiles Dynamically
            const badgeEl = document.getElementById('header-user-badge');
            if (badgeEl) badgeEl.innerHTML = userBadge;

            const nameEl = document.getElementById('header-user-name');
            if (nameEl) nameEl.textContent = uName;

            const roleEl = document.getElementById('header-user-role');
            if (roleEl) roleEl.innerHTML = uRole;

            const avatarEl = document.getElementById('header-user-avatar');
            if (avatarEl) avatarEl.textContent = uAvatar;

            // 2. Re-render dynamic sidebar with ONLY permitted modules
        ...
        async function loadLiveEMRState() {
            try {
                ...
                // Sync Beds
                if (state.adt_beds && Array.isArray(state.adt_beds)) {
                ...
                // Sync ER Cases
                if (state.er_cases && Array.isArray(state.er_cases)) {
                ...
                // ==========================================
                // 1. DASHBOARD & ALL MODULE KPI STAT CARDS
                // ==========================================
                // Dashboard
                const statPatients = document.getElementById('dash-stat-patients');
                if (statPatients) statPatients.textContent = (state.patients || []).length.toLocaleString();

                const statAppts = document.getElementById('dash-stat-appointments');
                ...
                if (document.getElementById('adt-occupancy-rate')) document.getElementById('adt-occupancy-rate').textContent = occPct;

                // ER Cases
                const erCases = state.er_cases || [];
                const erCritical = erCases.filter(c => c.triage_level == 1 || c.triage_level == 2).length;
                if (document.getElementById('er-total-cases')) document.getElementById('er-total-cases').textContent = erCases.length;
                if (document.getElementById('er-critical-cases')) document.getElementById('er-critical-cases').textContent = erCritical;
                if (document.getElementById('er-bays-occupied')) document.getElementById('er-bays-occupied').textContent = `${erCases.length} / 6`;

                // Inventory & Supply Chain
                const invItems = state.inventory_items || [];
                const lowStockCount = invItems.filter(i => (parseFloat(i.stock_qty) || 0) <= (parseFloat(i.reorder_level) || 0)).length;
                ...
                const vouchers = state.accounting_vouchers || [];
                const totalCash = vouchers.reduce((acc, v) => acc + (parseFloat(v.amount) || 0), 0);
                const claims = state.insurance_claims || [];
                ...
                if (document.getElementById('vax-monthly-doses')) document.getElementById('vax-monthly-doses').textContent = `${vaxList.length} Doses`;

                // Smart OPD Queue Management
                const queueList = state.queue_tickets || [];
                const servingToken = queueList.find(q => q.status === 'Serving') || queueList[0];
                const waitingTokens = queueList.filter(q => q.status === 'Waiting' || q.status === 'Pending').length;
                if (document.getElementById('queue-now-serving')) document.getElementById('queue-now-serving').textContent = servingToken ? servingToken.token_no : 'None';
                if (document.getElementById('queue-now-room-text')) document.getElementById('queue-now-room-text').textContent = servingToken ? `Now Serving in ${servingToken.counter_no}` : 'All counters clear';
                if (document.getElementById('queue-waiting-count')) document.getElementById('queue-waiting-count').textContent = `${waitingTokens} Patients`;
                if (document.getElementById('queue-avg-time')) document.getElementById('queue-avg-time').textContent = `${(waitingTokens * 2.5 + 1.5).toFixed(1)} min`;

                // CSSD Sterilization
                const cssdList = state.cssd_batches || [];
                if (document.getElementById('cssd-trays-ready')) document.getElementById('cssd-trays-ready').textContent = `${cssdList.length} Sets`;
                ...
                console.error('loadLiveEMRState error:', err);
            }
        }

        // 2. RENDER PATIENT TABLES (Master Reg + Dashboard)
        function renderLivePatientsTable(patients) {
            if (!patients || !Array.isArray(patients)) return;

            // Target all potential patient table bodies
            const targets = [
                document.getElementById('tbody-patient-reg'),
                document.getElementById('tbody-dashboard-patients'),
                document.querySelector('#patient-master-table tbody'),
                document.querySelector('#pat-master-table tbody'),
                document.querySelector('#view-patient-reg table tbody')
            ];
                ...
                patients.forEach(p => {
                    ...
                    tr.innerHTML = `
                        ...
                        <td>
                            ...
                            <button class="btn-secondary" style="padding: 4px 8px; font-size: 11px; margin-right:4px;" onclick="viewPatient360('${p.name}', '${p.patient_no}')">
                                <i class="fa-solid fa-id-card"></i> 360°
                            </button>
                            <button class="btn-secondary" style="padding: 3px 6px; font-size: 11px;" onclick="openUniversalEditor('patients', ${p.id})">
                                <i class="fa-solid fa-pen"></i>
                            </button>
                            <button class="btn-secondary" style="padding: 3px 6px; font-size: 11px; color:#ef4444;" onclick="deleteLiveRecord('patients', ${p.id})">
            ...
            // Update KPI counters
            const patCounters = [
                document.getElementById('dash-total-patients'),
                document.getElementById('kpi-total-patients'),
                document.querySelector('#view-patient-reg .stat-content h3'),
                document.querySelector('#view-dashboard .kpi-card:nth-of-type(1) .kpi-val')
            ];
            patCounters.forEach(el => {
                if (el) el.textContent = patients.length;
            });
        }

        // 3. POPULATE PATIENT DROPDOWNS & MODAL LISTS
        function populatePatientDropdowns(patients) {
            if (!patients || !Array.isArray(patients)) return;

            // Update select dropdowns
            const dropdownIds = ['apt-patient', 'edit-bed-patient', 'inv-pat-select', 'rx-patient-name', 'lab-pat-name', 'tok-patient-select', 'vax-patient-select', 'mrd-patient-select'];
            dropdownIds.forEach(id => {
                const select = document.getElementById(id);
                if (!select) return;
                const currentVal = select.value;
                select.innerHTML = '';
                if (id === 'edit-bed-patient') {
                    select.innerHTML = '<option value="">-- No Patient (Bed Empty) --</option>';
                }
                patients.forEach(p => {
                    const opt = document.createElement('option');
                    opt.value = p.name;
                    opt.textContent = `${p.name} (${p.patient_no})`;
                    select.appendChild(opt);
                });
                if (currentVal) select.value = currentVal;
            });

            // Update Doctor Desk OPD Queue sidebar
            const opdList = document.getElementById('clinical-opd-queue-list');
            const opdCount = document.getElementById('opd-queue-count');
            if (opdCount) opdCount.textContent = `${patients.length} Total`;
            if (opdList) {
                opdList.innerHTML = '';
                patients.forEach((p, idx) => {
                    const qItem = document.createElement('div');
                    qItem.className = `queue-item ${idx === 0 ? 'active' : ''}`;
            ...
            // Update modal patient switcher list
            const modalLists = [
                document.getElementById('patient-modal-list'),
                document.getElementById('pat-modal-list')
            ];

            modalLists.forEach(mList => {
                if (!mList) return;
                mList.innerHTML = '';
                patients.forEach(p => {
                    ...
                    item.onclick = () => { setActivePatient(p.name); closeModal('modal-select-patient'); };
                    item.innerHTML = `
                        <div style="display:flex; justify-content:space-between; align-items:center; width:100%;">
                            ...
                            <button class="btn-select-pat" style="padding:4px 8px; font-size:11px;" onclick="setActivePatient(\'John Doe\')"><i class="fa-solid fa-check"></i> Select</button>
                        </div>
                    `;
        ...
        // 4. RENDER ALL OTHER HMIS MODULE TABLES
        function renderAllDynamicTables(state) {
            ...
            renderTableHelper('tbody-procurement', state.procurement_po, (po) => `
                ...
                <td><strong>${po.vendor_name || po.supplier_name || 'Vendor'}</strong></td>
                <td>${po.payment_terms || po.items_summary || 'Net 30 Days'}</td>
                <td>$ ${Number(po.total_amount).toLocaleString('en-US', {minimumFractionDigits: 2})}</td>
                <td>${po.po_date || po.order_date || '2026-08-24'}</td>
                <td><span class="status-badge status-active">${po.delivery_status || po.status || 'Received'}</span></td>
                <td>
            ...
            renderTableHelper('tbody-fixedassets', state.fixed_assets, (ast) => `
                <td><strong>${ast.asset_tag || ast.asset_code}</strong></td>
                <td><strong>${ast.asset_name}</strong></td>
                <td>${ast.department}</td>
                <td>$ ${Number(ast.cost || 0).toLocaleString('en-US', {minimumFractionDigits: 2})}</td>
            ...
            renderTableHelper('tbody-ot', state.ot_schedules, (ot) => `
                ...
                <td>${ot.theater_no || ot.ot_room || 'OR-1'}</td>
                <td>${ot.surgeon_name}</td>
                <td>${ot.surgery_date || ot.schedule_date || '2026-08-25'}</td>
            ...
            renderTableHelper('tbody-vaccination', state.vaccination_records, (vax) => `
                <td><strong>${vax.reg_no || vax.record_no}</strong></td>
                <td><strong>${vax.patient_name}</strong></td>
                <td>${vax.vaccine_name}</td>
                <td>${vax.dose_stage || vax.dose_number}</td>
                <td>${vax.batch_lot || vax.batch_no}</td>
                <td>${vax.administered_date || vax.date_given}</td>
                <td>
            ...
            renderTableHelper('tbody-queue', state.queue_tickets, (q) => `
                ...
                <td>${q.service_desk || q.department || 'Outpatient'}</td>
                <td>${q.issued_time || q.counter_no || '09:00 AM'}</td>
            ...
            renderTableHelper('tbody-cssd', state.cssd_batches, (cssd) => `
                <td><strong>${cssd.batch_no || cssd.cycle_no}</strong></td>
                <td><strong>${cssd.set_name || cssd.autoclave_unit}</strong></td>
                <td>${cssd.tray_count || cssd.tray_type} Trays</td>
                <td>${cssd.autoclave_cycle || cssd.sterilization_time}</td>
                <td>${cssd.expiry_date || '2026-09-24'}</td>
            ...
            renderTableHelper('tbody-ehs', state.ehs_incidents, (ehs) => `
                <td><strong>${ehs.incident_id || ehs.incident_no}</strong></td>
                <td>${ehs.logged_date || ehs.incident_date}</td>
                <td>${ehs.department}</td>
                <td><span class="status-badge status-urgent">${ehs.severity}</span></td>
                <td>${ehs.incident_type || ehs.description}</td>
            ...
            renderTableHelper('tbody-substore', state.substore_inventory, (sub) => `
                <td><strong>${sub.store_name || sub.substore_name}</strong></td>
                <td><strong>${sub.item_name}</strong></td>
                <td>${sub.qty_available || sub.current_stock}</td>
                <td>${sub.min_required || sub.min_threshold}</td>
                <td><span class="status-badge status-active">${sub.restock_status || sub.status}</span></td>
                <td>
            ...
            // 21. Dashboard AI CRM Lead Queue
            renderTableHelper('tbody-dashboard-aicrm', (state.ai_crm_leads || []).slice(0, 5), (l) => `
                <td><i class="fa-brands fa-whatsapp" style="color:#25d366; font-size:16px;"></i> ${l.channel}</td>
                <td>${l.symptoms}</td>
                <td><span class="status-badge status-urgent">${l.predicted_dept}</span></td>
                <td>
                    <button class="btn-primary-action" style="padding:4px 8px; font-size:11px;" onclick="executeAIAutoBook('${l.patient_name}', 'Dr. Roberto Tan, MD', '${l.predicted_dept}')">Auto-Book</button>
                </td>
            `);

            // 22. AI CRM Lead Triage Pipeline (Second table)
            renderTableHelper('tbody-crm-leads', state.ai_crm_leads || [], (l) => `
                <td><strong>${l.lead_no}</strong></td>
                <td><strong>${l.patient_name}</strong></td>
                <td><i class="fa-brands fa-whatsapp" style="color:#25d366;"></i> ${l.channel}</td>
                <td>"${l.symptoms}"</td>
                ...
                <td><span class="status-badge status-active">${l.sentiment}</span></td>
                <td>
                    <button class="btn-primary-action" style="padding:4px 8px; font-size:11px;" onclick="executeAIAutoBook('${l.patient_name}', 'Dr. Roberto Tan, MD', '${l.predicted_dept}')">Book Consult</button>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px;" onclick="openUniversalEditor('ai_crm_leads', ${l.id})"><i class="fa-solid fa-pen"></i></button>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px; color:#ef4444;" onclick="deleteLiveRecord('ai_crm_leads', ${l.id})"><i class="fa-solid fa-trash"></i></button>
                </td>
            `);

            // 23. Clinical Prescriptions
            renderTableHelper('tbody-clinical-rx', state.prescriptions || [], (rx) => `
                <td><strong>${rx.medicine_name}</strong></td>
                <td>${rx.dosage || '1 Tab'}</td>
                <td>${rx.frequency || 'OD'}</td>
                <td>${rx.duration || '7 Days'}</td>
                <td>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px;" onclick="openUniversalEditor('prescriptions', ${rx.id})"><i class="fa-solid fa-pen"></i></button>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px; color:#ef4444;" onclick="deleteLiveRecord('prescriptions', ${rx.id})"><i class="fa-solid fa-trash"></i></button>
                </td>
            `);

            // 24. Nursing Station & e-MAR
            renderTableHelper('tbody-nursing', state.nursing_handovers || [], (n) => `
                <td><strong>${n.bed_no}</strong></td>
                <td><strong>${n.patient_name}</strong></td>
                <td>${n.medication_due}</td>
                <td>${n.dose_route || 'Oral with water'}</td>
                <td>${n.scheduled_time}</td>
                <td>
                    <button class="btn-accent-action" style="padding:3px 8px; font-size:11px;" onclick="showToast('Medication Administered & e-MAR Updated')">Administer</button>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px;" onclick="openUniversalEditor('nursing_handovers', ${n.id})"><i class="fa-solid fa-pen"></i></button>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px; color:#ef4444;" onclick="deleteLiveRecord('nursing_handovers', ${n.id})"><i class="fa-solid fa-trash"></i></button>
                </td>
            `);

            // 25. Pharmacy Dispensary & Stock
            renderTableHelper('tbody-pharmacy', state.inventory_items || [], (p) => `
            ...
            // 26. Clinical Templates & Macros
            renderTableHelper('tbody-templates', state.clinical_templates || [], (tpl) => `
                <td><strong>${tpl.template_code}</strong></td>
                <td>${tpl.title}</td>
                <td>${tpl.icd_code}</td>
                <td>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px;" onclick="loadMacroToEMR('${tpl.template_code}')">Use in Chart</button>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px;" onclick="openUniversalEditor('clinical_templates', ${tpl.id})"><i class="fa-solid fa-pen"></i></button>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px; color:#ef4444;" onclick="deleteLiveRecord('clinical_templates', ${tpl.id})"><i class="fa-solid fa-trash"></i></button>
                </td>
            `);

            // 27. Clinical Order Sets
            renderTableHelper('tbody-ordersets', state.order_sets || [], (set) => `
                <td><strong>${set.set_name}</strong></td>
                <td>${set.department}</td>
                <td>${set.items_count}</td>
                <td>
                    <button class="btn-primary-action" style="padding:3px 7px; font-size:11px;" onclick="attachRxSetToChart('${set.set_name}')">Attach</button>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px;" onclick="openUniversalEditor('order_sets', ${set.id})"><i class="fa-solid fa-pen"></i></button>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px; color:#ef4444;" onclick="deleteLiveRecord('order_sets', ${set.id})"><i class="fa-solid fa-trash"></i></button>
                </td>
            `);

            // 28. Clinical Verification & Dual Sign-offs
            renderTableHelper('tbody-verification', state.verification_alerts || [], (v) => `
                <td><strong>${v.order_title || v.item_title}</strong></td>
                <td>${v.department}</td>
                <td>${v.requested_by}</td>
                <td>${v.verification_reason || v.justification}</td>
                <td><span class="status-badge status-active">${v.status}</span></td>
                <td>
                    <button class="btn-accent-action" style="padding:3px 7px; font-size:11px;" onclick="showToast('Dual Sign-Off Authorized!')"><i class="fa-solid fa-check-double"></i> Authorize</button>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px;" onclick="openUniversalEditor('verification_alerts', ${v.id})"><i class="fa-solid fa-pen"></i></button>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px; color:#ef4444;" onclick="deleteLiveRecord('verification_alerts', ${v.id})"><i class="fa-solid fa-trash"></i></button>
                </td>
            `);

            // 29. Medical Records Department (MRD)
            renderTableHelper('tbody-mrd', state.mrd_records || [], (m) => `
                <td><strong>${m.mrd_no || m.hospital_no}</strong></td>
                <td><strong>${m.patient_name}</strong></td>
                <td>${m.discharge_date}</td>
                <td>${m.icd_primary || m.icd_code}</td>
                <td><span class="status-badge status-active">${m.custody_status || m.shelf_location || m.status}</span></td>
                <td>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px;" onclick="openUniversalEditor('mrd_records', ${m.id})"><i class="fa-solid fa-pen"></i></button>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px; color:#ef4444;" onclick="deleteLiveRecord('mrd_records', ${m.id})"><i class="fa-solid fa-trash"></i></button>
                </td>
            `);

            // 30. Information Helpdesk Queries
            renderTableHelper('tbody-helpdesk', state.helpdesk_queries || [], (h) => `
                <td><strong>${h.ticket_no}</strong></td>
                <td><strong>${h.caller_name || h.visitor_name}</strong></td>
                <td>${h.department || h.category}</td>
                <td>${h.query_text || h.action_taken}</td>
                <td>${h.priority || h.attending_staff}</td>
                <td><span class="status-badge status-active">${h.status}</span></td>
                <td>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px;" onclick="openUniversalEditor('helpdesk_queries', ${h.id})"><i class="fa-solid fa-pen"></i></button>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px; color:#ef4444;" onclick="deleteLiveRecord('helpdesk_queries', ${h.id})"><i class="fa-solid fa-trash"></i></button>
                </td>
            `);

            // 31. Executive MIS Revenue Breakdown
            const totalInv = (state.billing_invoices || []).reduce((acc, inv) => acc + (parseFloat(inv.net_total) || 0), 0);
            const totalAppts = (state.appointments || []).length;
            const totalBeds = (state.adt_beds || []).filter(b => b.status === 'Occupied').length;
            const totalRx = (state.prescriptions || []).length;

            renderTableHelper('tbody-reports', [
                { dept: 'Clinical OPD & Consultation', volume: totalAppts, gross: totalAppts * 1000, hmo: totalAppts * 400, net: totalAppts * 600 },
                { dept: 'Inpatient Ward & ICU (ADT)', volume: totalBeds, gross: totalBeds * 10000, hmo: totalBeds * 6000, net: totalBeds * 4000 },
                { dept: 'Laboratory & Diagnostics', volume: (state.lab_orders || []).length, gross: (state.lab_orders || []).length * 800, hmo: (state.lab_orders || []).length * 300, net: (state.lab_orders || []).length * 500 },
                { dept: 'Pharmacy Dispensary', volume: totalRx, gross: totalInv, hmo: totalInv * 0.2, net: totalInv * 0.8 }
            ], (r) => `
            ...
            renderTableHelper('tbody-users', state.system_users || [], (u) => `
                <td><strong>${u.username}</strong></td>
                <td>${u.full_name}</td>
                <td><span class="status-badge status-completed">${u.badge_label || u.role}</span></td>
                <td>${u.department || u.allowed_modules}</td>
                <td><span class="status-badge status-active">${u.status || u.session_status || 'Active'}</span></td>
                <td>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px;" onclick="openUniversalEditor('system_users', ${u.id})"><i class="fa-solid fa-pen"></i></button>
                    <button class="btn-secondary" style="padding:3px 7px; font-size:11px; color:#ef4444;" onclick="deleteLiveRecord('system_users', ${u.id})"><i class="fa-solid fa-trash"></i></button>
                </td>
            `);
        }
        ...
        function renderTableHelper(tbodyId, dataList, rowRenderer) {
            ...
            if (!dataList || dataList.length === 0) {
                tbody.innerHTML = '<tr><td colspan="10" style="text-align:center; padding:24px; color:#64748b;"><i class="fa-solid fa-folder-open" style="font-size:20px; opacity:0.4; margin-bottom:6px; display:block;"></i>No records found in database</td></tr>';
                return;
            }
            tbody.innerHTML = '';
        ...
        async function submitNewPatient() {
            ...
            const scheme = document.getElementById('np-scheme')?.value;
            const address = document.getElementById('np-address')?.value?.trim();

            if (!fname || !lname || !age) {
                showToast('Please fill in required fields: First Name, Last Name, and Age.');
                return;
            }

            const patientNo = 'G1-' + new Date().getFullYear() + '-' + String(Math.floor(Math.random() * 9000) + 1000);
            const payload = {
        ...
        async function saveNewAppointment() {
            const patientName = document.getElementById('apt-patient')?.value || 'Mary Smith';
        ...
        // ==========================================
        // CRUD: SUBMIT NEW BILLING INVOICE
        // ==========================================
        async function submitNewBillingInvoice() {
            const patientName = document.getElementById('inv-pat-select')?.value;
            const itemDesc = document.getElementById('inv-item-desc')?.value?.trim();
            const amount = document.getElementById('inv-amount')?.value?.trim();
            const discount = document.getElementById('inv-discount')?.value?.trim() || '0';
            const paymentMode = document.getElementById('inv-pay-mode')?.value || 'Cash';

            if (!patientName || !itemDesc || !amount) {
                showToast('Please fill in Patient, Item Description, and Amount.');
                return;
            }

            const amtNum = parseFloat(amount) || 0;
            const discNum = parseFloat(discount) || 0;
            const netTotal = amtNum - discNum;
        ...
        // ==========================================
        function printBillingInvoice(invoiceNo) {
            const invoices = LIVE_EMR_STATE.billing_invoices || [];
            const inv = invoices.find(i => i.invoice_no === invoiceNo);
            if (!inv) {
                showToast('Invoice ' + invoiceNo + ' not found.');
                return;
            }
    ...
    <div id="modal-eligibility-inquiry" class="modal-overlay">
        ...
        // ==========================================
        // CRUD: SUBMIT INCIDENT REPORT
        // ==========================================
        async function submitIncidentReport() {
            const staff = document.getElementById('inc-staff')?.value?.trim();
            const dept = document.getElementById('inc-dept')?.value;
            const category = document.getElementById('inc-category')?.value;
            const severity = document.getElementById('inc-severity')?.value;

            if (!staff) {
                showToast('Please enter the affected staff name.');
                return;
            }
        ...
        // ==========================================
        // CRUD: SUBMIT NEW CLINICAL TEMPLATE
        // ==========================================
        async function submitNewTemplate() {
            const code = document.getElementById('tpl-code')?.value?.trim();
            const title = document.getElementById('tpl-title')?.value?.trim();
            const icd = document.getElementById('tpl-icd')?.value?.trim();
            const body = document.getElementById('tpl-body')?.value?.trim();

            if (!code || !title) {
                showToast('Please fill in Template Code and Title.');
                return;
            }
        ...
        // ==========================================
        // CRUD: SUBMIT NEW PURCHASE ORDER
        // ==========================================
        async function submitNewPO() {
            ...
            const total = document.getElementById('po-total')?.value?.trim();

            if (!vendor || !items) {
                showToast('Please fill in Vendor and Requisition Items.');
                return;
            }
        ...
        // ==========================================
        // CRUD: SUBMIT NEW JOURNAL VOUCHER
        // ==========================================
        async function submitNewVoucher() {
            const narration = document.getElementById('jv-narration')?.value?.trim();
            const debit = document.getElementById('jv-debit')?.value?.trim();
            const credit = document.getElementById('jv-credit')?.value?.trim();
            const amount = document.getElementById('jv-amount')?.value?.trim();

            if (!narration || !debit || !credit || !amount) {
                showToast('Please fill in all Journal Voucher fields.');
                return;
            }

            const voucherNo = 'JV-' + new Date().getFullYear() + '-' + String(Math.floor(Math.random() * 900) + 100);
            const payload = {
        ...
        // ==========================================
        // CRUD: ISSUE NEW QUEUE TOKEN
        // ==========================================
        async function submitNewToken() {
            const patient = document.getElementById('tok-patient-select')?.value;
            const dept = document.getElementById('tok-dept')?.value;
            const counter = document.getElementById('tok-counter')?.value;
            const priority = document.getElementById('tok-priority')?.value || 'Regular';

            if (!patient || !dept || !counter) {
                showToast('Please select patient, department, and counter room.');
                return;
            }

            const prefix = dept.startsWith('P') ? 'P' : (dept.startsWith('C') ? 'C' : 'A');
            const tokenNo = prefix + '-' + String(Math.floor(Math.random() * 800) + 100);
        ...
        // ==========================================
        async function callNextQueueToken() {
            const queue = LIVE_EMR_STATE.queue_tickets || [];
            const nextWaiting = queue.find(q => q.status === 'Waiting' || q.status === 'Pending');
            if (!nextWaiting) {
                showToast('ℹ️ No waiting tokens in queue.');
                return;
            }
        ...
        // ==========================================
        // CRUD: RECORD VACCINE DOSE
        // ==========================================
        async function submitRecordVaccine() {
            const patient = document.getElementById('vax-patient-select')?.value;
            const antigen = document.getElementById('vax-antigen')?.value;
            const dose = document.getElementById('vax-dose')?.value;
            const batch = document.getElementById('vax-batch')?.value?.trim() || 'LOT-2026-A1';
            const adminBy = document.getElementById('vax-admin-by')?.value?.trim() || 'Nurse Joy Reyes, RN';

            if (!patient || !antigen || !dose) {
                showToast('Please select Patient, Vaccine Antigen, and Dose Number.');
                return;
            }

            const recordNo = 'VAX-' + new Date().getFullYear() + '-' + String(Math.floor(Math.random() * 9000) + 1000);
            const payload = {
                record_no: recordNo,
                patient_name: patient,
                vaccine_name: antigen,
                dose_number: dose,
                batch_no: batch,
        ...
        // ==========================================
        // CRUD: START CSSD CYCLE
        // ==========================================
        async function submitStartCSSD() {
            const unit = document.getElementById('cssd-unit')?.value;
            const tray = document.getElementById('cssd-tray')?.value?.trim();
            const cycle = document.getElementById('cssd-cycle-time')?.value;
            const bio = document.getElementById('cssd-bio')?.value;

            if (!tray) {
                showToast('Please specify instrument tray description.');
                return;
            }

            const cycleNo = 'CSSD-' + new Date().getFullYear() + '-' + String(Math.floor(Math.random() * 900) + 100);
            const payload = {
                cycle_no: cycleNo,
                autoclave_unit: unit,
                tray_type: tray,
                sterilization_time: cycle,
                biological_indicator: bio,
                operator: 'Tech Rommel Garcia',
                status: 'Passed'
            };
        ...
        // ==========================================
        // CRUD: ARCHIVE MRD RECORD
        // ==========================================
        async function submitArchiveMRD() {
            const patient = document.getElementById('mrd-patient-select')?.value;
            const disch = document.getElementById('mrd-disch-date')?.value || new Date().toISOString().split('T')[0];
            const icd = document.getElementById('mrd-icd')?.value?.trim() || 'Z00.0 - General Exam';
            const shelf = document.getElementById('mrd-shelf')?.value?.trim() || 'Rack 01, Shelf A';

            if (!patient) {
                showToast('Please select a patient to archive.');
                return;
            }

            const hospNo = 'G1-' + new Date().getFullYear() + '-' + String(Math.floor(Math.random() * 9000) + 1000);
            const payload = {
                hospital_no: hospNo,
                patient_name: patient,
        ...
        // ==========================================
        // CRUD: CREATE STAFF USER ACCOUNT
        // ==========================================
        async function submitCreateUser() {
            ...
            const modules = document.getElementById('usr-modules')?.value;

            if (!username || !fullName) {
                showToast('Please fill in Username and Full Staff Name.');
                return;
            }
        ...
        // ==========================================
        // CRUD: ADD WAREHOUSE INVENTORY ITEM
        // ==========================================
        async function submitNewStockItem() {
            const code = document.getElementById('itm-code')?.value?.trim();
            const name = document.getElementById('itm-name')?.value?.trim();
            const category = document.getElementById('itm-cat')?.value;
            const batch = document.getElementById('itm-batch')?.value?.trim() || 'BAT-2026-X1';
            const qty = document.getElementById('itm-qty')?.value?.trim();
            const price = document.getElementById('itm-price')?.value?.trim();
            const reorder = document.getElementById('itm-reorder')?.value?.trim() || '20';

            if (!code || !name || !qty || !price) {
                showToast('Please fill in Item Code, Name, Quantity, and Unit Price.');
                return;
            }
        ...
        const PATIENT_RECORDS = {
            'John Doe': {
                ...
                age: '45 Y',
                gender: 'Male',
                meta: '68 Y / Male &bull; Medicare Part B',
            ...
            'Mary Smith': {
                ...
                age: '34 Y',
                gender: 'Female',
                meta: '34 Y / Female &bull; Blue Cross Blue Shield',
                scheme: 'Blue Cross Blue Shield',
                bp: '115/75',
                pulse: '72',
                temp: '36.6',
                spo2: '99%',
        ...
        function quickAdmitBed(bedId, event) {
            ...
            if (!document.getElementById('edit-bed-patient').value) {
                document.getElementById('edit-bed-patient').value = 'John Doe';
                setBedStatusDraft('occupied');
            }
        }
        ...
        function setActivePatient(patientName) {
            ...
            if (document.getElementById('global-pat-name')) document.getElementById('global-pat-name').textContent = pat.name;
            if (document.getElementById('global-pat-code')) document.getElementById('global-pat-code').textContent = pat.code;
            if (document.getElementById('global-pat-meta')) document.getElementById('global-pat-meta').innerHTML = pat.meta;
