...
from core.repositories import InMemoryRepository, IRepository, SQLiteRepository


# 1. PATIENT APPLICATION SERVICE
class PatientService:
    def __init__(self, patient_repo: IRepository, audit_repo: IRepository | None = None):
...
class BillingService:
    def __init__(self, billing_repo: IRepository, audit_repo: IRepository | None = None):
...
class TriageService:
    def __init__(self, er_repo: IRepository, audit_repo: IRepository | None = None):
